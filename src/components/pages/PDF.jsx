...
const PDF = () => {
  ...
  const { formData, courseData, selectedCity, selectedDate } = location.state || {};
  ...
  return (    <div className="print-A4 max-w-screen-2xl mx-auto font-times overflow-hidden min-h-screen flex flex-col print:min-h-screen print:flex print:flex-col relative">
