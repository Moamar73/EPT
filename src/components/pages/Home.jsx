...
import SearchByCompetencies from '../SearchByCompetencies';
...
const TrainersSection = lazy(() => import('../TrainersSection'));
const PlacesCarousel = lazy(() => import('../PlacesCarousel'));
const SkillsSection = lazy(() => import('../SkillsSection'));
const SpecialtiesSection = lazy(() => import('../SpecialtiesSection'));
const ClientsCarousel = lazy(() => import('../ClientsCarousel'));
    ...
    <div className='max-w-screen-2xl mx-auto font-arial mb-20'>
      ...
      <section id='places-section'>
        <div className='container-px places-headings bg-[linear-gradient(182.49deg,_#2D108C_-20.63%,_#DA0E29_49.15%)] lg:py-[60px] md:py-12 py-9'>
          <h2 className='xl:text-[48px] lg:text-[43px] md:text-[32px] text-[29px] font-goldman text-white lg:mb-5 mb-3'>
      ...
      {/* employees assessment section */}
      <section className='container-px bg-[#F6F6F6] py-[60px] gap-5 flex max-md:flex-col max-md:items-center'>
        <div className='max-md:order-2'>
          <h2 className='font-bold text-red xl:text-[28px] lg:text-[24px] md:text-[20px] xs:text-[32px] text-[20px] mb-[14px]'>
            Employees Assessment
          </h2>
          <h3 className='font-goldman xl:text-[40px] lg:text-[32px] md:text-[27px] xs:text-[32px] text-[27px] text-blue mb-[10px]'>
