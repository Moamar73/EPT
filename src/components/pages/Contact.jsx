  ...
  return (
    <div className="max-w-screen-2xl mx-auto font-arial">
        <section className="container-px bg-[#F2F2F2] py-[50px]">
            <h1 className="font-goldman text-center mb-10 xs:text-[30px] text-[24px]">We are just a click away</h1>
            <form className="w-full" onSubmit={handleSubmit}>
                <div className="grid lg:grid-cols-7 gap-7 mb-10">
                    <div className="grid lg:grid-cols-1 sm:grid-cols-2 gap-7 lg:col-span-3">
                        <input 
                            className="placeholder:font-goldman p-3 border border-gray-300 rounded" 
                            type="text" 
                            name="name" 
                            value={formData.name}
                    ...
                    <textarea 
                        className="resize-none lg:col-span-4 p-3 placeholder:font-goldman min-h-[200px] border border-gray-300 rounded" 
                        name="comment" 
                ...
                <button 
                    className={`btn-yellow !rounded-none !text-[20px] !px-12 mx-auto block transition-opacity ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`} 
                    type="submit"
