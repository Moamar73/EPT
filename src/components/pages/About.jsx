...
const statistics = [
    {icon: "trained-group", number: 3, text: "Partners across Europe and Saudi Arabia"},{icon: "programs-group", number: 12, text: "Cities where we deliver our courses"},
    {icon: "bag-solid", number: 10, text: "Specialized training fields"},{icon: "hospital-solid", number: 63, text: "Certified expert trainers"},
]
    ...
    <div className="max-w-screen-2xl mx-auto font-arial">
        ...
        <section className="container-px flex justify-between max-lg:flex-col gap-x-11 font-times pt-9">
            <div className="py-5 pb-16 px-2 xl:max-w-[850px] lg:max-w-[520px] max-w-full w-full">
                <div>
                    <h1 className="font-goldman mb-6 text-[#F9B223] xl:text-[35px] lg:text-[31px] xs:text-[35px] text-[30px]">Who are we?</h1>
                    <p className="xl:text-[20px] lg:text-[16px] xs:text-[20px] text-[#545353]">
                        <span className="xl:text-[36px] lg:text-[32px] xs:text-[36px] text-[30px] text-gray-700">E</span>
                        urope Professional Training is a trusted Europe-based training provider offering over 600 professional courses in
                            ...
                            We’re committed to delivering high-quality training to professionals globally. <br/> Registered in England and Wales under Company 
            ...
            <div className="flex-center w-full xl:max-w-[500px] lg:max-w-[340px]">
                <picture>
                    ...
                    <img className="max-xs:max-h-[400px]" src="imgs/About/Rectangle-30197.png" alt="Rectangle-30197" />
                </picture>
            </div>
        </section>

        {/* services section */}
        <section className="container-px group bg-[#EFF2F7] py-11 font-goldman xl:text-[18px] lg:text-[15px] sm:text-[16px] xs:text-[14.5px]">
            <div>
            ...
            <div className="grid lg:grid-cols-4 xs:grid-cols-2 mt-11 gap-11">
                <div className="flex-center flex-col gap-7 xl:px-7 px-5 sm:py-11 xs:py-6 py-11 bg-[#ffffff] rounded-[7px]">
                    <picture>
