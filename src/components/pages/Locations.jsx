            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-3 xs:grid-cols-2 gap-x-[14.5px] gap-y-10">
                {locations.map(({ title, icon, img, number }) => (
                    <div
                        ...
                        key={title}
                        onClick={() => navigate(`/courses?city=${encodeURIComponent(title)}`)}
                    >
                        <div className="bg-blue py-2 px-3 text-white capitalize xl:text-[20px] text-[18px] max-md:text-[20px] z-10">
                            <h4>{title}</h4>
                        </div>
                            ...
                            <div className="flex-center rounded-full absolute bottom-0 translate-y-1/4 left-1/2 -translate-x-1/2 w-[27%] h-[32%]">
                                <div
                                    className="relative p-[4px] bg-[#F5F5F5] rounded-full w-full h-full
                                                                ...
                                                                before:border-blue before:scale-0 before:transition-transform before:duration-500 group-hover:before:scale-110 before:z-20"
                                >
                                    ...
                                    <div className="flex-center bg-blue rounded-full p-1 w-full h-full z-10 relative">
                                        <picture>
                        ...
                        <div className="h-[91px] max-xs:h-[120px] max-[400px]:h-[91px] xl:text-[18px] max-md:text-[18px] flex-center text-blue">
                            {number} Locations
                        </div>
                    </div>
                ))}
