    ...
    <section id="skills-section" className="container-px flex justify-between max-lg:flex-col max-lg:max-w-[89%] max-md:max-w-none mx-auto xl:gap-x-16 gap-x-6 gap-y-10 md:py-[76.5px] py-[58.5px]">
        <div className="relative select-none">
          ...
          <picture>
            ...
            <img className="absolute top-0 right-0 animate-spin-slow w-[34%]" src="imgs/Home/023.png" alt="skills" loading="lazy" />
          </picture>
        </div>

        <div className="flex flex-col gap-10" ref={triggerRef}>
          <div className="skills-headings">
            <h2 className="text-yellowHome xl:text-[28px] xs:text-[26px] text-[19px] font-bold mb-[10px]">Courses Based on Competencies</h2>
            <h3 className="text-blue min-[1408px]:text-[40px] lg:text-[31px] md:text-[36px] xs:text-[29px] text-[22px] max-[370px]:text-[21px] font-bold">
              Enhancing employees’ skills through <span className="text-darkRed relative inline-block">300 Competencies
                <picture>
          ...
          <div className="text-blue font-bold capitalize flex flex-col gap-y-[30px]">
            <div>
              <h4>Organization & Planning</h4>
              <div className="bg-[#E6E7E9] rounded-lg h-[8px] w-full mt-[10px] relative">
                <div className="progress-bar bg-[#FC767C] rounded-lg h-full w-0" data-percent="86%"></div>
            ...
            <div>
              ...
              <div className="bg-[#E6E7E9] rounded-lg h-[8px] w-full mt-[10px] relative">
                <div className="progress-bar bg-yellowHome rounded-lg h-full w-0"  data-percent="95%"></div>
            ...
            <div>
              ...
              <div className="bg-[#E6E7E9] rounded-lg h-[8px] w-full mt-[10px] relative">
                <div className="progress-bar bg-[#2EBBBB] rounded-lg h-full w-0" data-percent="90%"></div>
                <span className="absolute inline-block top-[-10px] -translate-y-[100%] left-[90%] -translate-x-1/2">90%</span>
              </div>
            </div>
          </div>

          <Link className="btn-yellow w-fit h-fit" to="/courses">Read More</Link>
        </div>
    </section>
  )
}
