  ...
  return (
    <section className="container-px flex justify-between max-md:flex-col gap-x-16 gap-y-10 md:py-[76.5px] py-[58.5px] bg-[#F6F6F6]">
        <div className="flex flex-col justify-center max-md:order-2">
            ...
            <h4 className="xl:text-[68px] lg:text-[52px] md:text-[36px] sm:text-[55px] xs:text-[42px] text-[36px] text-[#374957] font-goldman font-bold">Our Trainers</h4>
            ...
            <Link className="btn-yellow w-fit" to="/Trainers">Look</Link>
        </div>
